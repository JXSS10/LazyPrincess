...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://e.top4top.io/p_34500ewus1.jpg'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "X_XF8")
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '6169288210').split()]

QR_CODE_IMG = environ.get('QR_CODE_IMG','https://e.top4top.io/p_34500ewus1.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'X_XF8@ybl') #enter your upi id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/X_XF8/186') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'X_XF8')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adda™](https://t.me/X_XF8)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','X_XF8') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','S_S0F') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','S_S0F') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','LayDeveloperr')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+https://t.me/+2NuqaFNNlqZmMTA0") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/X_XF8"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/X_XF8"
...
# Born to make history @X_XF8 !
# Thank you X_XF8 for helping us in this Journey
# 🥰  Thank you for giving me credit @X_XF8r  🥰
# for any error please contact me -> telegram@X_XF8r or insta @X_XF8r 
# rip paid developers 🤣 - >> No need to buy paid source code while @X_XF8r is here 😍😍
